...
const EditBudgetModal = ({handleShowAddBudget, error, setBudgetCategory, budgetCategory, categories}) => {
    ...
    return (
        ...
        <div className="flex flex-row items-center justify-between my-4">
           ...
           />
           {!showTheme && <button className="bg-gray-900 text-white w-full mt-4 p-3 rounded-xl" onClick={handleSubmit}>Save changes</button>}
