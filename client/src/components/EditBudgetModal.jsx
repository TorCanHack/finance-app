...
const EditBudgetModal = ({handleShowAddBudget, error, budgetCategory,  maximumSpending, setMaximumSpending, data, showTheme, setShowTheme, budgetTheme, setBudgetTheme, handleEditBudget}) => {
